...
#define LED_PIN2        13
#define LED_PIN3        15
#define BTN_PIN         19             // Connect a push button to this pin to change patterns
...
const uint8_t kMatrixWidth = 13;                          // Matrix width
const uint8_t kMatrixHeight = 3;                         // Matrix height
...
void setup() {
  Serial.begin(115200);
  FastLED.addLeds<CHIPSET, LED_PIN, COLOR_ORDER>(leds, 0, kMatrixWidth).setCorrection(TypicalSMD5050);
  FastLED.addLeds<CHIPSET, LED_PIN2, COLOR_ORDER>(leds, kMatrixWidth, kMatrixWidth).setCorrection(TypicalSMD5050);
  FastLED.addLeds<CHIPSET, LED_PIN3, COLOR_ORDER>(leds, 2 * kMatrixWidth, kMatrixWidth).setCorrection(TypicalSMD5050);
